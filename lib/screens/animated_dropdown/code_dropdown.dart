// lib/screens/animated_dropdown/code_dropdown.dart
import 'dart:ui';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

const List<String> _codePrompts = [
...
class CodeDropdown extends StatefulWidget {
  ...
  @override
  State<CodeDropdown> createState() => _CodeDropdownState();
}
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ..._codePrompts.asMap().entries.map((e) {
                    final isLast = e.key == _codePrompts.length - 1;
                    return _PromptTile(
                      label: e.value,

// lib/screens/animated_dropdown/write_dropdown.dart
import 'dart:ui';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

const List<String> _writePrompts = [
...
class WriteDropdown extends StatefulWidget {
  ...
  @override
  State<WriteDropdown> createState() => _WriteDropdownState();
}

class _WriteDropdownState extends State<WriteDropdown>
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Prompts
                  ..._writePrompts.asMap().entries.map((e) {
                    final isLast = e.key == _writePrompts.length - 1;
                    return _PromptTile(
                      label: e.value,

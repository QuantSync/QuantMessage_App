// lib/screens/animated_dropdown/something_new_dropdown.dart
import 'dart:ui';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

const List<String> _somethingNewPrompts = [
  'Explore ancient wisdom',
  'Analyze game theory applications',
  'Explore logical fallacies',
  'Discuss food science',
  'Analyze decision-making frameworks',
];

class SomethingNewDropdown extends StatefulWidget {
  final VoidCallback onClose;
  final ValueChanged<String> onQuerySelected;
  final bool isMobile;

  const SomethingNewDropdown({
    super.key,
  ...
  @override
  State<SomethingNewDropdown> createState() => _SomethingNewDropdownState();
}

class _SomethingNewDropdownState extends State<SomethingNewDropdown>
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ..._somethingNewPrompts.asMap().entries.map((e) {
                    final isLast = e.key == _somethingNewPrompts.length - 1;
                    return _PromptTile(
                      label: e.value,

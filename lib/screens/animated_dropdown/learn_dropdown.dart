// lib/screens/animated_dropdown/learn_dropdown.dart
import 'dart:ui';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

const List<String> _learnPrompts = [
  'Create good lecture notes',
  'Prepare for an exam or interview',
  'Help me make sense of these ideas',
  'Create a curriculum inspired by my favorite cultural movement',
  'Transform a dry subject into something fascinating',
];
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ..._learnPrompts.asMap().entries.map((e) {
                    final isLast = e.key == _learnPrompts.length - 1;
                    return _PromptTile(
                      label: e.value,

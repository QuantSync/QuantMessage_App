    ...
    try {
      ...
      if (response.user != null) {
        ...
        await _api.getAIResponse(
            "Hello AI, I just signed in using ${welcomeModel.name}.",
            response.user!.id
        );
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: const Text('Welcome back!', style: TextStyle(color: Colors.white)),
      ...
      child: Column(
        ...
        children: [
          ...
          FadeInLeft(
            ...
            duration: const Duration(milliseconds: 1000),
            child: Text(
              "Sign in to your account and unlock the full power of our multi-agent AI ecosystem.",
          ...
          FadeInUp(
            ...
            child: Wrap(
              ...
              runSpacing: 12,
              children: [
                _buildFeatureChip(Icons.shield_outlined, "Secure Login"),
                _buildFeatureChip(Icons.bolt_rounded, "Lightning Fast"),
                _buildFeatureChip(Icons.psychology_outlined, "AI Powered"),
              ],
            ),
          ),
        ],
